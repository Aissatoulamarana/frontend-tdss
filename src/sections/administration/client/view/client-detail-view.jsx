...
const TABS_BANQUE = [
    ...
    { value: 'utilisateurs', label: 'Utilisateurs', icon: <Iconify icon="solar:users-group-rounded-bold" width={24} /> },
    { value: 'banques', label: 'Paiements', icon: <Iconify icon="solar:card-transfer-bold" width={24} /> },
];
...
const TABS_ENTREPRISE = [
    ...
    { value: 'paiement', label: 'Paiements', icon: <Iconify icon="solar:card-transfer-bold" width={24} /> },
    { value: 'facture', label: 'Factures', icon: <Iconify icon="solar:bill-list-bold" width={24} /> },
    { value: 'penalite', label: 'Pénalités', icon: <Iconify icon="solar:shield-warning-bold" width={24} /> },
    { value: 'utilisateurs', label: 'Utilisateurs', icon: <Iconify icon="solar:users-group-rounded-bold" width={24} /> },
];
