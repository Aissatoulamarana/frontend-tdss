...
export const NewClientSchema = zod.object({
  ...
  sigle: zod.string().min(1, { message: 'le sigle de la structure est obligatoire' }),
            ...
            <Grid item size={{ xs: 12, md: 8 }}>
              ...
              >
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item size={{ xs: 8, md: 6 }}>
                    <Field.Text name="sigle" label="Sigle  *" fullWidth size="small" />
                  </Grid>
