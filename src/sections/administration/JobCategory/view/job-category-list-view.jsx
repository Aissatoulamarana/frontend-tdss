...
export function JobCategoryListView() {
  ...
  useEffect(() => {
    const fetchFonctions = async () => {
      try {
        ...
        const fonctions = response.data.results || []; 
  ...
  return (
    <DashboardContent>
      <CustomBreadcrumbs
        heading="Liste des catégories professionnelles"
        links={[
          { name: 'Dashboard', href: paths.dashboard.root },
          { name: 'Catégorie Professionnelle', href: paths.dashboard.fonction.root },
          { name: 'Liste des catégories professionnelles' },
        ]}
        action={
          <Button
