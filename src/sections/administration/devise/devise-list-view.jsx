...
import { TableRowComDevise } from 'src/sections/composants/table-row';
// ----------------------------------------------------------------------
...
export function DeviseListView() {
    ...
    useEffect(() => {
        ...
        const fetchRegions = async () => {
            try {
                const response = await axios.get(API.listDevises());
            ...
            <DashboardContent maxWidth="xl">
                <CustomBreadcrumbs
                    ...
                    links={[
                        ...
                        { name: 'Devises', href: paths.dashboard.devise.root },
