...
export function RegionListView() {
    ...
    useEffect(() => {
        ...
        const fetchRegions = async () => {
            try {
                const response = await axios.get(API.listRegions());
    ...
    return (
        <>
            <DashboardContent maxWidth="xl">
                <CustomBreadcrumbs
                    heading="Listes des régions"
                    links={[
                        { name: 'Dashboard', href: paths.dashboard.root },
                        { name: 'Regions', href: paths.dashboard.region.list },
                        { name: 'Listes des Regions' },
                    ]}
            ...
            <ConfirmDialog
                ...
                content={
                    <>
                        Etes vous sûr de vouloir supprimer <strong> {table.selected.length} </strong> regions?
                    </>
                }
                action={
                    <Button
