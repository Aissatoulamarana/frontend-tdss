...
export function ProfilTypeListView() {
    ...
    return (
        <>
            <DashboardContent maxWidth="xl">
                <CustomBreadcrumbs
                    heading="Types de profil"
                    links={[
                        { name: 'Dashboard', href: paths.dashboard.root },
                        { name: 'Type Profil', href: paths.dashboard.profilType.root },
                        { name: 'Types de profil' },
                    ]}
            ...
            <ConfirmDialog
                ...
                content={
                    <>
                        Etes vous sûr de vouloir supprimer <strong> {table.selected.length} </strong> type de profil?
                    </>
                }
                action={
                    <Button
